...
// Narrowing the type by adding undefined as a type value
// conditions can be used to narrow types
d.abc;

// ways to check type when narrowing it:
// if (d.abc) {
// or:
if (typeof d.abc === 'object') {

// or:
// see that the below is not possible:
